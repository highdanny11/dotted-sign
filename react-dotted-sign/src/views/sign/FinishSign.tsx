  ...
  return (
    <div className='bg-[rgba(206,229,228,0.2)]'>
      ...
      <div className="max-w-[437px]">
        ...
        <Button onClick={finishSignPDF} theme='primary' size='lg' type="button" className="min-h-[48px] w-full items-center justify-center rounded md:max-w-[191px] mb-2">
          下載檔案
        </Button>
        <Button onClick={backHome} theme='primary-inline' size='lg' type="button" className="min-h-[48px] w-full items-center justify-center rounded md:max-w-[191px] mb-2">
         重新上傳
        </Button>
      </div>
    </div>
